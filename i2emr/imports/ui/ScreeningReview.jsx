...
const populateField = (info, station, field) => {
...
const getNoOfLines = (info, station, field) => {
  if (info && typeof (info[station]) !== "undefined" && typeof (info[station][field]) !== "undefined") {
    if (typeof(info[station][field]) == "string") {
      return info[station][field].split('\n').length
    }
  }
  return 1;
            ...
            <Grid item xs={12}>
              ...
              <Fragment>
                ...
                >
                  ...
                  <Divider /><br />
                  <Grid container direction="row" justify="space-between" alignItems="center" >
                    <Grid item xs={12}>Participant's presenting complaints/concerns (if any) <TextField rows={getNoOfLines(info, 'Hx HCSR', 'hxHcsrQ2')} variant="outlined" fullWidth={true} multiline={true} margin="dense" value={populateField(info, 'Hx HCSR', 'hxHcsrQ2')} /></Grid>
                  </Grid>
                  <Divider /><br />
                  ...
                  <Grid container direction="row" justify="space-between" alignItems="center" >
                    <Grid item xs={4}><Typography variant="h4">Urinary Incontinence</Typography></Grid>
                    <Grid item xs={8}><Typography variant="h4">Hearing</Typography></Grid>
                  </Grid>
                  <Divider /><br />
                  <Grid container direction="row" justify="space-between" alignItems="flex-end" >
                    <Grid item xs={2}>Average Blood Pressure (Systolic): <TextField variant="outlined" fullWidth={true} margin="dense" value={populateField(info, 'Hx Cancer', 'hxCancerQ17')} /></Grid>
                    <Grid item xs={2}>Average Blood Pressure (Diastolic): <TextField variant="outlined" fullWidth={true} margin="dense" value={populateField(info, 'Hx Cancer', 'hxCancerQ18')} /></Grid>
                    <Grid item xs={2}>BMI: <TextField variant="outlined" fullWidth={true} margin="dense" inputProps={isBmiToBeFlag(info)} value={populateField(info, 'Hx Cancer', 'hxCancerQ21')} /></Grid>
                    <Grid item xs={2}>Height (in cm): <TextField variant="outlined" error={true} fullWidth={true} margin="dense" value={populateField(info, 'Hx Cancer', 'hxCancerQ19')} /></Grid>
                    <Grid item xs={2}>Weight (in kg): <TextField variant="outlined" fullWidth={true} margin="dense" value={populateField(info, 'Hx Cancer', 'hxCancerQ20')} /></Grid>
                    <Grid item xs={2}>Waist Circumference (in cm): <TextField variant="outlined" fullWidth={true} margin="dense" value={populateField(info, 'Hx Cancer', 'hxCancerQ24')} /></Grid>
                  </Grid>
                  <Divider /><br />
                  <Grid container direction="row" justify="space-between" alignItems="flex-start" >
                    <Grid item xs={4}><Typography variant="subtitle1" color="error">{getBpMessage(info)}</Typography></Grid>
