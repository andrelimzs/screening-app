...
class Form extends Component {
  constructor() {
    ...
    this.stations = ["Registration","Height & weight","CBG & Hb","Phlebotomy", "Pap Smear","Breast Exam","Blood Pressure", "Doctors' Consult", "Eye Screening","Pre-Women's Education Quiz","Done"];
